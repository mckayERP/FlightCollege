...
/** Generated Model for CT_DataSet
 *  @author Adempiere (generated) 
 *  @version Release 3.8.0 - $Id$ */
public class X_CT_DataSet extends PO implements I_CT_DataSet, I_Persistent 
{
    ...
    public X_CT_DataSet (Properties ctx, int CT_DataSet_ID, String trxName)
    {
    ...
    /** Load Constructor */
    public X_CT_DataSet (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_CT_DataSet[")
        .append(get_ID()).append("]");
      return sb.toString();
    }

	/** Set Data Set ID.
		@param CT_DataSet_ID Data Set ID	  */
