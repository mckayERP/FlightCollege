...
/** Generated Model for FTU_Instructor
 *  @author Adempiere (generated) 
 *  @version OFC Custom 3.8.0_2 - $Id$ */
public class X_FTU_Instructor extends PO implements I_FTU_Instructor, I_Persistent 
{
    ...
    public X_FTU_Instructor (Properties ctx, int FTU_Instructor_ID, String trxName)
    {
      ...
      /** if (FTU_Instructor_ID == 0)
        {
			setC_BPartner_ID (0);
			setFTU_Instructor_ID (0);
			setS_Resource_ID (0);
        } */
    }

    /** Load Constructor */
    public X_FTU_Instructor (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_FTU_Instructor[")
	...
	public void setFTU_Instructor_ID (int FTU_Instructor_ID)
	{
		if (FTU_Instructor_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_FTU_Instructor_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_FTU_Instructor_ID, Integer.valueOf(FTU_Instructor_ID));
	}
