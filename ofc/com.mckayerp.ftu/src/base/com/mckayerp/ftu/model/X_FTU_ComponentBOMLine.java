...
/** Generated Model for FTU_ComponentBOMLine
 *  @author Adempiere (generated) 
 *  @version Release 3.8.0 - $Id$ */
public class X_FTU_ComponentBOMLine extends PO implements I_FTU_ComponentBOMLine, I_Persistent 
{
    ...
    public X_FTU_ComponentBOMLine (Properties ctx, int FTU_ComponentBOMLine_ID, String trxName)
    {
      super (ctx, FTU_ComponentBOMLine_ID, trxName);
      /** if (FTU_ComponentBOMLine_ID == 0)
        {
			setFTU_ComponentBOMLine_ID (0);
        } */
    }

    /** Load Constructor */
    public X_FTU_ComponentBOMLine (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_FTU_ComponentBOMLine[")
	...
	public com.mckayerp.ftu.model.I_FTU_ComponentBOM getFTU_ComponentBOM() throws RuntimeException
    {
		return (com.mckayerp.ftu.model.I_FTU_ComponentBOM)MTable.get(getCtx(), com.mckayerp.ftu.model.I_FTU_ComponentBOM.Table_Name)
			.getPO(getFTU_ComponentBOM_ID(), get_TrxName());	}
	...
	public void setFTU_ComponentBOM_ID (int FTU_ComponentBOM_ID)
	{
		if (FTU_ComponentBOM_ID < 1) 
			set_Value (COLUMNNAME_FTU_ComponentBOM_ID, null);
		else 
			set_Value (COLUMNNAME_FTU_ComponentBOM_ID, Integer.valueOf(FTU_ComponentBOM_ID));
	}
	...
	/** Set Component BOM Line.
		@param FTU_ComponentBOMLine_ID 
		A component included in an assembly
	  */
	public void setFTU_ComponentBOMLine_ID (int FTU_ComponentBOMLine_ID)
	{
		if (FTU_ComponentBOMLine_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_FTU_ComponentBOMLine_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_FTU_ComponentBOMLine_ID, Integer.valueOf(FTU_ComponentBOMLine_ID));
	}

	/** Get Component BOM Line.
		@return A component included in an assembly
	  */
	public int getFTU_ComponentBOMLine_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_FTU_ComponentBOMLine_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
