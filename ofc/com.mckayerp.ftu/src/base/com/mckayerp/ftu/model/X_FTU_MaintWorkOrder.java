...
public class X_FTU_MaintWorkOrder extends PO implements I_FTU_MaintWorkOrder, I_Persistent 
{
    ...
    {
      super (ctx, FTU_MaintWorkOrder_ID, trxName);
      /** if (FTU_MaintWorkOrder_ID == 0)
        {
			setC_DocType_ID (0);
...
// N
    ...
    /** Load Constructor */
    public X_FTU_MaintWorkOrder (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_FTU_MaintWorkOrder[")
