...
/** Generated Model for FTU_CompLifeCycleModel
 *  @author Adempiere (generated) 
 *  @version Release 3.8.0 - $Id$ */
public class X_FTU_CompLifeCycleModel extends PO implements I_FTU_CompLifeCycleModel, I_Persistent 
{
    ...
    public X_FTU_CompLifeCycleModel (Properties ctx, int FTU_CompLifeCycleModel_ID, String trxName)
    {
      super (ctx, FTU_CompLifeCycleModel_ID, trxName);
      /** if (FTU_CompLifeCycleModel_ID == 0)
        {
			setFTU_CompLifeCycleModel_ID (0);
			setLifeUsageSource (null);
        } */
    }

    /** Load Constructor */
    public X_FTU_CompLifeCycleModel (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_FTU_CompLifeCycleModel[")
	...
	/** Set Component Life Cycle Model.
		@param FTU_CompLifeCycleModel_ID 
		The component life cycle model to use when creating new components for this product.
	  */
	public void setFTU_CompLifeCycleModel_ID (int FTU_CompLifeCycleModel_ID)
	{
		if (FTU_CompLifeCycleModel_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_FTU_CompLifeCycleModel_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_FTU_CompLifeCycleModel_ID, Integer.valueOf(FTU_CompLifeCycleModel_ID));
	}

	/** Get Component Life Cycle Model.
		@return The component life cycle model to use when creating new components for this product.
	  */
	public int getFTU_CompLifeCycleModel_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_FTU_CompLifeCycleModel_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
