...
public final class DisplayType
{
	...
	/** Display Type 1000092 DataPoint */
	public static final int DataPoint = 1000092;
	//	Candidates: 
	...
	public static boolean isID (int displayType)
	{
		if (displayType == ID || displayType == Table || displayType == TableDir
			...
			|| displayType == Image || displayType == Color || displayType == DataPoint)
			return true;
		return false;
	}	//	isID
	...
	public static boolean isLookup(int displayType)
	{
		if (displayType == List || displayType == Table
			...
			|| displayType == PAttribute || displayType == DataPoint || displayType == Color)
			return true;
		return false;
	}	//	isLookup
