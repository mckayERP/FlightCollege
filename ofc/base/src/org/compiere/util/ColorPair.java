 ...
 */
public abstract class ColorPair implements Comparator<Object>, Serializable, Comparable
{
	/**
	 * 
	 */
	 ...
	 */
	protected ColorPair (String name, Color color)
	{
		m_name = name;
		if (m_name == null)
			m_name = "";
		m_color = color;  // null allowed
	}   //  NamePair
	...
	{
		if (m_color != null)
			return m_name + " [" + m_color.getRed() + ", " + m_color.getGreen() + ", " + m_color.getBlue() + "]";
		else
			return m_name + "[]";
	}	//	toString
