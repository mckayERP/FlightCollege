...
public abstract class OFXBankStatementHandler extends DefaultHandler
{
	...
	private Timestamp parseOfxDate(String value) throws ParseException
	{
		try
		{
			// TODO: paramaterize the date format
			String dateFormat = "yyyyMMdd";
			SimpleDateFormat sdf = new SimpleDateFormat(dateFormat);
			sdf.setLenient(true);
			
			value = value.substring(0,dateFormat.length()); // 0,8 - not sure why the truncation is necessary but a parse error occurs without it.
