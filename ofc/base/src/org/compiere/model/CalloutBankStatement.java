		...
		if (currencyID != null)
		{
			...
			else
			{
				...
				if (mTab.getValue("DateAcct") != null)
				{
					...
					trxAmt = MConversionRate.convert(ctx, pmt.getPayAmt(true), pmt.getC_Currency_ID(), ((Integer) currencyID).intValue(), convDate, pmt.getC_ConversionType_ID(), AD_Client_ID.intValue(), AD_Org_ID.intValue());
				}
			}
