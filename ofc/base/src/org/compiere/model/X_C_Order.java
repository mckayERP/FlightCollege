...
// @#CreatedBy@
	...
	/** Set Apply Block Bookings.
		@param ApplyBlockBookings 
		If checked, available block booking amounts will be used to reduce the total amount of the order to zero or as close as possible depending on the blook booking amounts outstanding.
	  */
	public void setApplyBlockBookings (boolean ApplyBlockBookings)
	{
		set_Value (COLUMNNAME_ApplyBlockBookings, Boolean.valueOf(ApplyBlockBookings));
	}

	/** Get Apply Block Bookings.
		@return If checked, available block booking amounts will be used to reduce the total amount of the order to zero or as close as possible depending on the blook booking amounts outstanding.
	  */
	public boolean isApplyBlockBookings () 
	{
		Object oo = get_Value(COLUMNNAME_ApplyBlockBookings);
		if (oo != null) 
		{
...
//	}
	...
	/** Set Has Block Time?.
		@param HasBlockTime 
		Does the business partner have block time.  If so, check the Block Time window.
	  */
	public void setHasBlockTime (boolean HasBlockTime)
	{
		throw new IllegalArgumentException ("HasBlockTime is virtual column");	}

	/** Get Has Block Time?.
		@return Does the business partner have block time.  If so, check the Block Time window.
	  */
	public boolean isHasBlockTime () 
	{
		Object oo = get_Value(COLUMNNAME_HasBlockTime);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
	...
	/** Set OFC_Order_Line_Tab.
		@param OFC_Order_Line_Tab 
		A placeholder for the order line tab in the sales order.
	  */
	public void setOFC_Order_Line_Tab (boolean OFC_Order_Line_Tab)
	{
		set_Value (COLUMNNAME_OFC_Order_Line_Tab, Boolean.valueOf(OFC_Order_Line_Tab));
	}

	/** Get OFC_Order_Line_Tab.
		@return A placeholder for the order line tab in the sales order.
	  */
	public boolean isOFC_Order_Line_Tab () 
	{
		Object oo = get_Value(COLUMNNAME_OFC_Order_Line_Tab);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
	...
	/** Set Update Flights.
		@param UpdateOpenFlights 
		Update the list of open flights.
	  */
	public void setUpdateOpenFlights (String UpdateOpenFlights)
	{
		set_Value (COLUMNNAME_UpdateOpenFlights, UpdateOpenFlights);
	}

	/** Get Update Flights.
		@return Update the list of open flights.
	  */
	public String getUpdateOpenFlights () 
	{
		return (String)get_Value(COLUMNNAME_UpdateOpenFlights);
	}
