...
//	  Do we have a mandatory rule
	...
	public Object getDefault()
	{
		...
		/**
		 *  (c) String Statement (including punctuation)
		 */
		defStr = "";
		if (m_vo.DefaultValue.startsWith("@S:="))
		{
			defStr = m_vo.DefaultValue.substring(4);	//	w/o tag
			log.fine("[Default String] " + m_vo.ColumnName + "=" + defStr);
			return createDefault(defStr);
		}
		 ...
		 */
		if (!m_vo.DefaultValue.equals("") && 
			!m_vo.DefaultValue.startsWith("@SQL=") &&
			!m_vo.DefaultValue.startsWith("@S:="))
		{
