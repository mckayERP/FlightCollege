		...
		if (currencyID != null)
		{
			...
			else
			{
				...
				if (parent.getValue("DateAcct") != null)
				{
					...
					convertedAmt = MConversionRate.convert(ctx, pmt.getPayAmt(), pmt.getC_Currency_ID(), ((Integer) currencyID).intValue(), convDate, pmt.getC_ConversionType_ID(), AD_Client_ID.intValue(), AD_Org_ID.intValue());
				}
			}
