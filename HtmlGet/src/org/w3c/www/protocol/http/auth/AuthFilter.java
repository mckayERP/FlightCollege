// AuthFilter.java
// $Id: AuthFilter.java,v 1.1.2.1 2003/05/28 22:58:52 owenc Exp $
...
public class AuthFilter implements PropRequestFilter {
     ...
     */
    protected static Hashtable<String, CachedRealm[]> realms = new Hashtable<String, CachedRealm[]>(13);
    /**
	...
	CachedRealm cache[] = realms.get(srvkey);
	if ( cache == null ) {
