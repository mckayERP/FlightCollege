// FilterEngine.java
// $Id: FilterEngine.java,v 1.1.2.1 2003/05/28 22:58:51 owenc Exp $
...
class ScopeNode {
    ...
    synchronized void resolve(Vector<RequestFilter> into) {
...
class FilterEngine {
	...
	Vector<Object> parts = new Vector<Object>(8);
	...
	Vector<RequestFilter>    applies = new Vector<RequestFilter>();
	while (node != null) {
