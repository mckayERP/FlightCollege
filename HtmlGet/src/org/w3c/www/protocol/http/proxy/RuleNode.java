...
// $Id: RuleNode.java,v 1.1.2.1 2003/05/28 22:58:53 owenc Exp $
...
public class RuleNode {
     ...
     */
    Hashtable<String, RuleNode> children = null;
    ...
    public Hashtable<String, RuleNode> getChildren(){ 
	return children;
    }
	...
	if ( children == null ) 
	    children = new Hashtable<String, RuleNode>(5);
	...
	return ((children != null) ? children.get(tok) : null);
    }
