// MimeHeaders.java
// $Id: MimeHeaders.java,v 1.1.2.1 2003/05/28 22:58:50 owenc Exp $
...
public class MimeHeaders implements MimeHeaderHolder {
    ...
    public Enumeration<String> enumerateHeaders() {
	if ( headers == null )
	    return null;
	return headers.keys();
    }
	...
	Enumeration<String> names = enumerateHeaders();
	if ( names != null ) {
